...
dependencies {
	    compile 'com.github.raxden:AndroidCommons:v2.0.1@aar'
}
```
...
For a **detailed documentation**, please have a look at the [**Wiki**](https://github.com/raxden/AndroidCommons/wiki).
