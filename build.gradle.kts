...
subprojects {
    ...
    configurations.all {
        ...
        exclude(group = "com.raxdenstudios", module = "commons-glide")
        exclude(group = "com.raxdenstudios", module = "commons-okhttp3")
        ...
        exclude(group = "com.raxdenstudios", module = "commons-retrofit")
        exclude(group = "com.raxdenstudios", module = "commons-retrofit-rx")
