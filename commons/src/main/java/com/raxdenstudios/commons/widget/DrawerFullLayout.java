...
public class DrawerFullLayout extends DrawerLayout {

	private static final int MIN_DRAWER_MARGIN = 0;

    public DrawerFullLayout(Context context) {
        super(context);
    }

    public DrawerFullLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public DrawerFullLayout(Context context, AttributeSet attrs, int defStyle) {
